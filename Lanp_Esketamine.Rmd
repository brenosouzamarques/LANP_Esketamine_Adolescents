...
packages = c("tidyverse", "haven",
             "lsr", "rstatix", "coin", "boot", "skimr", "kableExtra",
...
### Create a function to perform Paired Samples T-tests and print the results with effect sizes

``` {r}

```

#### Perform Paired Samples T-tests for each outcome
```{r}
