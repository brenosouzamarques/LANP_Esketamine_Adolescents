...
The first step is to load the dataset into R. To correctly load the data, place the "dataset.sav" file in the same directory of this R Markdown script.

```{r, warning = F, message = F}
set.seed(252009) # for reproducible bootstrap results
